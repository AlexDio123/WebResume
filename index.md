        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <p class="lead mb-5">I am experienced in leveraging agile frameworks to robus and eficient solutions. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.</p>
            ...
            <section class="resume-section" id="awards">
                <div class="resume-section-content">
                    ...
                    <ul class="fa-ul mb-0">
                        ...
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            Activate in Big Data (EOI)
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            Advanced Python (Mescyt)
                        </li>
                    </ul>
                </div>
            </section>
